        ...
        <div className="modal-counter-showcase-wrap">
          <div className="modal-counter-buttons">
            <button className="modal-crease">
              <img className="modal-count-button" src={Increase} onClick={() => increase(cartItem)} alt="increase button"/>
            </button>
            <p className="modal-count">{qty}</p>
            {
              qty >= 2 ?
                <button className="modal-crease">
                  <img className="modal-count-button" src={Decrease} onClick={() => decrease(cartItem)} alt="decrease button"/>
                </button>
                :
                <button className="modal-crease">
                  <img className="modal-count-button" src={Decrease} onClick={() => remove(cartItem)} alt="decrease button"/>
                </button>
            }
          </div>
